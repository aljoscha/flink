      ...
      this.outputSchema.get(i).getType match {
        ...
        case _ =>
          throw new RuntimeException(
            "Invalid type " + this.outputSchema.get(i).getType +
              " encountered.")
      }
    ...
    this.fieldNames.length match {
      ...
      case 8 =>
        new Tuple8(vals(0), vals(1), vals(2), vals(3), vals(4), vals(5), vals(6), vals(7))
          .asInstanceOf[T]
      case 9 =>
        new Tuple9(vals(0), vals(1), vals(2), vals(3), vals(4), vals(5), vals(6), vals(7), vals(8))
          .asInstanceOf[T]
      case 10 =>
        new Tuple10(
          vals(0),
