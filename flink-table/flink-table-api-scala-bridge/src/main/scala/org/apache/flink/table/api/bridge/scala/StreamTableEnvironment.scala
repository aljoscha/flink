...
trait StreamTableEnvironment extends TableEnvironment {
   ...
   * [[StreamExecutionEnvironment]]. In contrast to the [[TableEnvironment]] this environment
...
object StreamTableEnvironment {
   ...
   * @deprecated
   *   Use [[create(StreamExecutionEnvironment)]] and [[StreamTableEnvironment#getConfig()]] for
   *   manipulating the [[TableConfig]].
   */
  @deprecated
  def create(
      executionEnvironment: StreamExecutionEnvironment,
    ...
    StreamTableEnvironmentImpl
      .create(executionEnvironment, EnvironmentSettings.newInstance().build(), tableConfig)
  }
}
