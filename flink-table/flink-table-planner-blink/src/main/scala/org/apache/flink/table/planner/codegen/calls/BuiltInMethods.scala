...
object BuiltInMethods {
  ...
  val ROUND_DOUBLE =
    Types.lookupMethod(classOf[SqlFunctions], "sround", classOf[Double], classOf[Int])
  ...
  val UNIX_TIME_TO_STRING =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "unixTimeToString", classOf[Int])
  ...
  val STRING_TO_DATE_WITH_FORMAT =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "strToDate", classOf[String], classOf[String])
  ...
  val DATE_FORMAT_STIRNG_STRING =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateFormat", classOf[String], classOf[String])
  ...
  val UNIX_TIMESTAMP = Types.lookupMethod(classOf[SqlDateTimeUtils], "unixTimestamp")

  val UNIX_TIMESTAMP_TS =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "unixTimestamp", classOf[Long])
  ...
  val FROM_UNIXTIME =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "fromUnixtime", classOf[Long], classOf[TimeZone])
  ...
  val DATEDIFF_T_S =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateDiff", classOf[Long], classOf[String])

  val DATEDIFF_S_S =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateDiff", classOf[String], classOf[String])

  val DATEDIFF_S_T =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateDiff", classOf[String], classOf[Long])

  val DATEDIFF_T_T =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateDiff", classOf[Long], classOf[Long])
  ...
  val DATE_SUB_S =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateSub", classOf[String], classOf[Int])

  val DATE_SUB_T =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateSub", classOf[Long], classOf[Int])
  ...
  val DATE_ADD_S =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateAdd", classOf[String], classOf[Int])

  val DATE_ADD_T =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateAdd", classOf[Long], classOf[Int])

  val LONG_TO_TIMESTAMP =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "toTimestamp", classOf[Long])

  val DOUBLE_TO_TIMESTAMP =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "toTimestamp", classOf[Double])

  val DECIMAL_TO_TIMESTAMP =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "toTimestamp", classOf[DecimalData])

  val STRING_TO_TIMESTAMP =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "toTimestampData", classOf[String])
  ...
  val STRING_TO_TIMESTAMP_TIME_ZONE =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "toTimestamp", classOf[String], classOf[TimeZone])
  ...
  val TIMESTAMP_TO_BIGINT =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "fromTimestamp", classOf[Long])
  ...
  val STRING_TO_DATE =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "dateStringToUnixDate", classOf[String])

  val STRING_TO_TIME =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "timeStringToUnixDate", classOf[String])

  val TRUNCATE_DOUBLE_ONE = Types.lookupMethod(classOf[SqlFunctions], "struncate", classOf[Double])
  val TRUNCATE_FLOAT_ONE =
    Types.lookupMethod(classOf[SqlFunctionUtils], "struncate", classOf[Float])
  val TRUNCATE_INT_ONE = Types.lookupMethod(classOf[SqlFunctions], "struncate", classOf[Int])
  val TRUNCATE_LONG_ONE = Types.lookupMethod(classOf[SqlFunctions], "struncate", classOf[Long])
  val TRUNCATE_DEC_ONE =
    Types.lookupMethod(classOf[SqlFunctionUtils], "struncate", classOf[DecimalData])

  val TRUNCATE_DOUBLE =
    Types.lookupMethod(classOf[SqlFunctions], "struncate", classOf[Double], classOf[Int])
  val TRUNCATE_FLOAT =
    Types.lookupMethod(classOf[SqlFunctionUtils], "struncate", classOf[Float], classOf[Int])
  val TRUNCATE_INT =
    Types.lookupMethod(classOf[SqlFunctions], "struncate", classOf[Int], classOf[Int])
  val TRUNCATE_LONG =
    Types.lookupMethod(classOf[SqlFunctions], "struncate", classOf[Long], classOf[Int])
  val TRUNCATE_DEC =
    Types.lookupMethod(classOf[SqlFunctionUtils], "struncate", classOf[DecimalData], classOf[Int])

  val UNIX_DATE_CEIL =
    Types.lookupMethod(classOf[DateTimeUtils], "unixDateCeil", classOf[TimeUnitRange], classOf[Int])

  val TRUNCATE_SQL_TIMESTAMP =
    Types.lookupMethod(classOf[SqlDateTimeUtils], "truncate", classOf[TimestampData], classOf[Int])

  val ADD_MONTHS =
    Types.lookupMethod(classOf[SqlFunctions], "addMonths", classOf[Long], classOf[Int])

  val SUBTRACT_MONTHS =
    Types.lookupMethod(classOf[SqlFunctions], "subtractMonths", classOf[Long], classOf[Long])
}
