...
object StringCallGen {
  ...
  def generateConcat(
    ...
    generateCallIfArgsNullable(ctx, new VarCharType(VarCharType.MAX_LENGTH), operands) { terms =>
      s"$BINARY_STRING_UTIL.concat(${terms.mkString(", ")})"
    }
  }
  ...
  def generateConcatWs(
      ...
      operands: Seq[GeneratedExpression]): GeneratedExpression = {
    generateCallIfArgsNullable(ctx, new VarCharType(VarCharType.MAX_LENGTH), operands) { terms =>
      s"$BINARY_STRING_UTIL.concatWs(${terms.mkString(", ")})"
    }
  }
  ...
  def generateStringEquals(
    ...
    generateCallIfArgsNotNull(ctx, new BooleanType(), Seq(left, right)) { terms =>
      s"(${terms.head}.equals(${terms(1)}))"
    }
  }
  ...
  def generateSubString(
      ctx: CodeGeneratorContext,
      operands: Seq[GeneratedExpression]): GeneratedExpression = {
    generateCallIfArgsNotNull(ctx, new VarCharType(VarCharType.MAX_LENGTH), operands) { terms =>
      s"$BINARY_STRING_UTIL.substringSQL(${terms.head}, ${terms.drop(1).mkString(", ")})"
    }
  }
  ...
  def generateSimilarTo(
    ...
    generateCallIfArgsNotNull(ctx, new BooleanType(), operands) { terms =>
      s"$className.similar(${toStringTerms(terms, operands)})"
    }
  }
  ...
  def generateRegexpExtract(
    ...
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.regexpExtract(${safeToStringTerms(terms, operands)})"
    }
  }
  ...
  def generateRegexpReplace(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.regexpReplace(${toStringTerms(terms, operands)})"
    }
  }
  ...
  def generateIsDecimal(
      ...
      operands: Seq[GeneratedExpression]): GeneratedExpression = {
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateCallIfArgsNullable(ctx, new BooleanType(), operands) { terms =>
      s"$className.isDecimal(${safeToStringTerms(terms, operands)})"
    }
  }
  ...
  def generateIsDigit(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateCallIfArgsNullable(ctx, new BooleanType(), operands) { terms =>
      s"$className.isDigit(${safeToStringTerms(terms, operands)})"
    }
  }

  def generateAscii(ctx: CodeGeneratorContext, str: GeneratedExpression): GeneratedExpression = {
    generateCallIfArgsNotNull(ctx, new IntType(), Seq(str)) { terms =>
      s"${terms.head}.getSizeInBytes() <= 0 ? 0 : (int) ${terms.head}.byteAt(0)"
    }
  }
  ...
  def generateIsAlpha(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateCallIfArgsNullable(ctx, new BooleanType(), operands) { terms =>
      s"$className.isAlpha(${safeToStringTerms(terms, operands)})"
    }
  }
  ...
  def generateInitcap(
    ...
    val className = classOf[SqlFunctions].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.initcap(${terms.head}.toString())"
    }
  }
  ...
  def generatePosition(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateCallIfArgsNotNull(ctx, new IntType(), operands) { terms =>
      s"$className.position(${terms.mkString(",")})"
    }
  }
  ...
  def generateOverlay(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.overlay(${toStringTerms(terms, operands)})"
    }
  }
  ...
  def generateArithmeticConcat(
      ...
      left: GeneratedExpression,
      right: GeneratedExpression): GeneratedExpression = {
    generateStringResultCallIfArgsNotNull(ctx, Seq(left, right)) { terms =>
      s"${terms.head}.toString() + String.valueOf(${terms(1)})"
    }
  }
  ...
  def generateRepeat(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.repeat(${toStringTerms(terms, operands)})"
    }
  }
  ...
  def generateReverse(
      ...
      operands: Seq[GeneratedExpression]): GeneratedExpression = {
    generateCallIfArgsNotNull(ctx, new VarCharType(VarCharType.MAX_LENGTH), operands) { terms =>
      s"$BINARY_STRING_UTIL.reverse(${terms.head})"
    }
  }
  ...
  def generateReplace(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.replace(${toStringTerms(terms, operands)})"
    }
  }
  ...
  def generateSplitIndex(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.splitIndex(${toStringTerms(terms, operands)})"
    }
  }
  ...
  def generateHashCode(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateCallIfArgsNotNull(ctx, new IntType(), operands) { terms =>
      s"$className.hashCode(${terms.head}.toString())"
    }
  }
  ...
  def generateHashInternal(
    ...
    if (operands.length == 1) {
      generateCallIfArgsNotNull(ctx, new VarCharType(VarCharType.MAX_LENGTH), operands) { terms =>
        s"$BINARY_STRING_UTIL.hash(${terms.head}, $digestTerm)"
      }
    } else {
      val className = classOf[SqlFunctionUtils].getCanonicalName
      generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
        s"$className.hash($digestTerm, ${toStringTerms(terms, operands)})"
      }
    }
  }
  ...
  def generateParserUrl(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.parseUrl(${safeToStringTerms(terms, operands)})"
    }
  }
  ...
  def generateFromBase64(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateCallIfArgsNotNull(ctx, new VarCharType(VarCharType.MAX_LENGTH), operands) { terms =>
      s"$className.fromBase64(${terms.head})"
    }
  }
  ...
  def generateToBase64(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.toBase64(${terms.head})"
    }
  }
  ...
  def generateRegExp(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateCallIfArgsNotNull(ctx, new BooleanType(), operands) { terms =>
      s"$className.regExp(${toStringTerms(terms, operands)})"
    }
  }
  ...
  def generateBin(
      ...
      operands: Seq[GeneratedExpression]): GeneratedExpression = {
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"Long.toBinaryString(${terms.head})"
    }
  }
  ...
  def generateTrimLeft(
      ...
      operands: Seq[GeneratedExpression]): GeneratedExpression = {
    generateCallIfArgsNotNull(ctx, new VarCharType(VarCharType.MAX_LENGTH), operands) { terms =>
      s"$BINARY_STRING_UTIL.trimLeft(${terms.mkString(", ")})"
    }
  }
  ...
  def generateTrimRight(
      ...
      operands: Seq[GeneratedExpression]): GeneratedExpression = {
    generateCallIfArgsNotNull(ctx, new VarCharType(VarCharType.MAX_LENGTH), operands) { terms =>
      s"$BINARY_STRING_UTIL.trimRight(${terms.mkString(", ")})"
    }
  }
  ...
  def generateUuid(
    ...
    val className = classOf[SqlFunctionUtils].getCanonicalName
    generateStringResultCallIfArgsNotNull(ctx, operands) { terms =>
      s"$className.uuid(${terms.mkString(",")})"
    }
  }
  ...
  def generateStrToMap(
    ...
    generateCallIfArgsNotNull(ctx, t, operands) { terms =>
  ...
  def generateEncode(
    ...
    generateCallIfArgsNotNull(ctx, new VarBinaryType(VarBinaryType.MAX_LENGTH), Seq(str, charset)) {
  ...
  def generateDecode(
      ...
      charset: GeneratedExpression): GeneratedExpression = {
    generateStringResultCallIfArgsNotNull(ctx, Seq(binary, charset)) { terms =>
