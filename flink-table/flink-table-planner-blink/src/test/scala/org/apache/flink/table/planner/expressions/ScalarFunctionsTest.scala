...
class ScalarFunctionsTest extends ScalarTypesTestBase {
  ...
  def testOverlay(): Unit = {
    ...
    cases.foreach(x => {
      testAllApis(ExpressionParser.parseExpression(x._1), x._1, x._2, x._3)
    })
  ...
  def testAscii(): Unit = {
    ...
    testSqlApi("ascii(cast (null AS VARCHAR))", "null")

    testSqlApi("ascii('val_238') = ascii('val_239')", "true")
  }
  ...
  def testInstr(): Unit = {
    ...
    testSqlApi("instr(cast (null AS VARCHAR), 'e')", "null")

    testSqlApi("instr('e', cast (null AS VARCHAR))", "null")

    testSqlApi("instr('val_238', '_') = instr('val_239', '_')", "true")

    testSqlApi("instr('val_239', '_')", "4")
  }
  ...
  def testFromBase64(): Unit = {
    ...
    testSqlApi("FROM_BASE64('5L2g5aW9')", "你好")
  ...
  def testToBase64(): Unit = {
    ...
    testSqlApi("TO_BASE64('你好')", "5L2g5aW9")
  ...
  @Test
  def testSubString(): Unit = {
    Array("substring", "substr").foreach { substr =>
...
//      "42")
  ...
  def testLog(): Unit = {
    ...
    testSqlApi("LOG(cast (null AS DOUBLE))", "null")

    testSqlApi("LOG(cast (null AS DOUBLE), 1)", "null")

    testSqlApi("LOG(1, cast (null AS DOUBLE))", "null")
    testSqlApi("LOG(cast (null AS DOUBLE), cast (null AS DOUBLE))", "null")
  }
  ...
  def testLog2(): Unit = {
    ...
    testSqlApi("LOG2(cast (null AS DOUBLE))", "null")
  }
  ...
  def testChr(): Unit = {
    ...
    testSqlApi("CHR(f42)", Character.MIN_VALUE.toString)

    testSqlApi("CHR(65)", "A")

    testSqlApi("CHR(CAST (-10 AS BIGINT))", "")

    testSqlApi("CHR(300)", ",")

    testSqlApi("CHR(97)", "a")

    testSqlApi("CHR(97 + 256)", "a")

    testSqlApi("CHR(-9)", "")

    testSqlApi("CHR(0)", Character.MIN_VALUE.toString)

    testSqlApi("CHR(149)", 149.toChar.toString)

    testSqlApi("CHR(cast (null AS BIGINT))", "null")
  }
  ...
  def testCurrentTimePoint(): Unit = {
    ...
    testSqlApi("CHAR_LENGTH(CAST(NOW() AS VARCHAR)) >= 12", "true")
  ...
  def testEncodeAndDecode(): Unit = {
    ...
    testSqlApi("encode(cast (null AS VARCHAR), 'utf-8')", "null")

    testSqlApi("encode(cast (null AS VARCHAR), cast (null AS VARCHAR))", "null")

    testSqlApi("encode('aabbef', cast (null AS VARCHAR))", "null")

    testSqlApi("decode(cast (null AS BINARY), 'utf-8')", "null")

    testSqlApi("decode(cast (null AS BINARY), cast (null AS VARCHAR))", "null")

    testSqlApi("decode(encode('aabbef', 'utf-8'), cast (null AS VARCHAR))", "null")
  ...
  def testIf(): Unit = {
    ...
    testSqlApi("IF(f7 < 5, f18, f52)", "1996-11-10 06:55:44.333")
  }
