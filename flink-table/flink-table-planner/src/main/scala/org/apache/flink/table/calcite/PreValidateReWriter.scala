 ...
 * sql node validation.
 */
class PreValidateReWriter(val catalogReader: CatalogReader, val typeFactory: RelDataTypeFactory)
    ...
    call match {
      case r: RichSqlInsert
        ...
        appendPartitionProjects(
          ...
          catalogReader,
          typeFactory,
          r.getSource.asInstanceOf[SqlSelect],
