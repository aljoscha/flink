  ...
  def generateFunction[F <: Function, T <: Any](
    ...
    val (functionClass, signature, inputStatements) =
      ...
      // MapFunction
        ...
        // declaration: make variable accessible for separated method
        reusableMemberStatements.add(s"private $inputTypeTerm $input1Term;")
        (baseClass, "Object map(Object _in1)", List(s"$input1Term = ($inputTypeTerm) _in1;"))
      }
      ...
      // FlatJoinFunction
        ...
        val inputTypeTerm2 = boxedTypeTermForTypeInfo(
          input2.getOrElse(
        ...
        (
          ...
          List(s"$input1Term = ($inputTypeTerm1) _in1;", s"$input2Term = ($inputTypeTerm2) _in2;"))
      }
