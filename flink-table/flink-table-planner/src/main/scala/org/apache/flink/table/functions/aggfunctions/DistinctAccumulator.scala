 ...
 *
 * @param distinctValueMap
 *   the [[MapView]] that stores the distinct filter hash map.
 */
class DistinctAccumulator(var distinctValueMap: MapView[Row, JLong]) {
  ...
  /**
   * Checks if the parameters are unique and adds the parameters to the distinct map. Returns true
   * if the parameters are unique (haven't been in the map yet), false otherwise.
   *
   * @param params
   *   the parameters to check.
   * @return
   *   true if the parameters are unique (haven't been in the map yet), false otherwise.
   */
   ...
   * instance. Returns true if no instances of the parameters remain in the map, false otherwise.
   *
   * @param params
   *   the parameters to check.
   * @return
   *   true if no instances of the parameters remain in the map, false otherwise.
   */
