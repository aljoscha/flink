...
/**
 * Flink RelNode which matches along with DataSource. It ensures that types without deterministic
 * field order (e.g. POJOs) are not part of the plan translation.
 *
 * This may read only part, or change the order of the fields available in a
 * [[org.apache.flink.api.common.typeutils.CompositeType]] of the underlying [[DataSet]]. The
