...
class CalcStringExpressionTest extends TableTestBase {
  ...
  def testNumericAutoCastInComparison() {
    val util = batchTestUtil()
    val table =
      util.addTable[(Byte, Short, Int, Long, Float, Double)]("Table", 'a, 'b, 'c, 'd, 'e, 'f)
  ...
  def testCasting() {
    val util = batchTestUtil()
    val table = util.addTable[(Int, Double, Long, Boolean)]("Table", '_1, '_2, '_3, '_4)
  ...
  def testCastFromString() {
    val util = batchTestUtil()
    val table = util.addTable[(String, String, String)]("Table", '_1, '_2, '_3)
