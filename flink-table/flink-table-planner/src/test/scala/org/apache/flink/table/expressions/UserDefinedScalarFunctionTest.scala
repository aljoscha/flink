...
class UserDefinedScalarFunctionTest extends ExpressionTestBase {
  ...
  def testParameters(): Unit = {
    ...
    // test row type input
    testAllApis(Func19('f14), "Func19(f14)", "Func19(f14)", "12,true,1,2,3")
  }
  ...
  def testNullableParameters(): Unit = {
    ...
    testAllApis(Func0(nullOf(INT_TYPE_INFO)), "Func0(nullOf(INT))", "Func0(NULL)", "-1")
  }
  ...
  def testOverloadedParameters(): Unit = {
    ...
    testAllApis(Func21('f15), "Func21(f15)", "Func21(f15)", "student#Bob")

    testAllApis(Func22('f16), "Func22(f16)", "Func22(f16)", "student#Bob")
  }
  ...
  override def typeInfo: TypeInformation[Any] = {
    new RowTypeInfo(
      ...
      TypeInformation.of(classOf[Array[GraduatedStudent]])).asInstanceOf[TypeInformation[Any]]
  }
